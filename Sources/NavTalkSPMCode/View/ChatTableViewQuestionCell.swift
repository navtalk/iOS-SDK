...
class ChatTableViewQuestionCell: UITableViewCell {
    ...
    func initUI(){
        ...
        messageView.backgroundColor = NavTalkManager.shared.navtalk_messageItem_user_backgroundColor
        messageLabel.textColor = NavTalkManager.shared.navtalk_messageItem_user_titleColor
        messageLabel.font = NavTalkManager.shared.navtalk_messageItem_user_titleFont
        messageView.layer.cornerRadius = NavTalkManager.shared.navtalk_messageItem_user_cornerRadius
